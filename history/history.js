...
//     // Update DOM elements
//     suhuElement.innerHTML = suhu;
//     tdsElement.innerHTML = tds;
//     kekeruhanElement.innerHTML = kekeruhan;
      ...
      if (snapshot.exists()) {
        ...
        reversedList.forEach((element) => {
          if (firstTime) {
            ...
            var suhu = element.suhu;
            var tds = element.tds;
            var kekeruhan = element.kekeruhan;
            var ph = element.ph;
